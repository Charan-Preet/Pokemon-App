...
function Cards() {
  ...
  const displaySearchedItems = () => {
    return (
      <article className="br2 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw5 center link black dim db mw5 pa2 br2 ba b--black-10 shadow-1">
        <div className="grow">
          <img
            src={`https://unpkg.com/pokeapi-sprites@2.0.2/sprites/pokemon/other/dream-world/${searchedPokemonId}.svg`}
          ...
          <div className="dt w-100 mt1">
            <div className="dtc">
              ...
              <h1 className="f5 f4-ns mv0">
                Weight: {searchItemData[0].weight} pounds
              </h1>
              <h1 className="f5 f4-ns mv0">
                Height: {searchItemData[0].height} meters
              </h1>
              <h1 className="f5 f4-ns mv0">
                Base Experience: {searchItemData[0].base_experience}{" "}
              </h1>
            </div>
          </div>
        </div>
      ...
      selectedItem.length > 0 && (
        <div className="flex flex-wrap w-90 justify-center">
          <div className="w-50 pa3 mr2 link black dim db mw5 pa2 br3 ba b--black-10 shadow-1 grow">
            <img
              src={`https://unpkg.com/pokeapi-sprites@2.0.2/sprites/pokemon/other/dream-world/${selectedId}.svg`}
              className="mw-100"
  ...
  const displayInitialPokemon = () => {
    return (
      <div>
        {displaySelected()}
        <div className="flex flex-wrap ml3 mr3 justify-around">{listItems}</div>
  ...
  const listItems = pokemonData.map((data) => (
    <article className="br2 ba dark-gray b--black-10 mv4 w-80 w-40-m w-40-l mw5 center br3 link black dim db mw5 pa2 br2 ba b--black-10 shadow-1">
      ...
      <div className="pa2 ph3-ns pb3-ns">
        ...
        <a
          className="f6 link dim ba ph3 pv2 mb2 dib hot-pink mt4 br3 w-100 pointer"
          onClick={() => showSelectedPokemon(data, data.url.split("/")[6])}
        >
          Select
        </a>
      </div>
  ...
  return (
    <div>
      {searchedPokemonId ? displaySearchedItems() : displayInitialPokemon()}
    </div>
  );
}
